...
\usepackage{rotating}
\usepackage{wrapfig}
\usepackage{verse} % For typesetting poems
\usepackage[T1]{fontenc} % For using non-standard fonts
\usepackage{calligra} % For calligraphy fonts
\usepackage{oldstyle} % For old-style fonts
\usepackage{lipsum} % For generating filler text
\usepackage{titlesec} % For setting section titles
\usepackage{booktabs}
\usepackage{longtable}
\usepackage{makecell}

% Command to handle dedication
\newcommand{\dedication}[1]{{\centering\Large\itshape\calligra #1\par}}

\newcommand{\dedicationtext}[1]{%
\begin{center}%
{\fontfamily{pzc}\selectfont\small #1}%
\end{center}%
}
