...
%%% AR
\arabicAbstract{ هذا العمل هو جزء من مشروع ختم الدروس الهندسية في المعهد العالي للإعلامية للسنة الدراسية 2023-2024. لقد أجرينا تدريباً مع شركة \textLR{Avaxia Group} في نهاية الدراسة بهدف تصميم وتنفيذ منصة تحليلية لتصور البيانات الوصفية لـ \textLR{Snowflake}. يستخدم هذا الحل بنية الخدمات المصغرة لتوفير المرونة والنمطية وقابلية التوسع, دمج خدمات التحليل والمراقبة في الوقت الفعلي لتحسين الأداء وإدارة البيانات.}
...
visualisation des métadonnées de Snowflake. Cette solution utilise une architecture microservices pour offrir une flexibilité, modularité et évolutivité, 
